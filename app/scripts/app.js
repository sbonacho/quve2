(function(document) {
	...
	// bottom-container.
	// The appName is moved to top and shrunk on condensing. The bottom sub
	// title
	...
	addEventListener('paper-header-transform', function(e) {
		...
		var maxMiddleScale = 0.50; // appName max size when condensed. The
